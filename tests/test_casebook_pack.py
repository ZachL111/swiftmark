"""Regression checks for the swiftmark casebook."""
...
from casebook.harness import assert_expected, swiftmark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(swiftmark_summary(), assert_expected())
