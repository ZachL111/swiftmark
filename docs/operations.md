...
`swiftmark` is centered on cli tools work in Swift. The technical target is: Index Markdown headings, links, and backlinks across a documentation tree.
...
The score is deterministic. The current threshold is 169. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 2.
