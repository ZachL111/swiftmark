...
swiftmark is a Swift project for cli tools. It focuses on this technical goal: Index Markdown headings, links, and backlinks across a documentation tree.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 169, risk penalty 4, latency penalty 4, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
